...
common = [
    ...
    (os.path.join("sharpy-sc2", "config.ini"), "config.ini"),
    # ("config-local.ini", None),
    (os.path.join("sharpy-sc2", "ladder.py"), "ladder.py"),
    (os.path.join("sharpy-sc2", "ladderbots.json"), None),
]
...
sawd_zip = LadderZip(
    "SelfAssemblingWorkerDisassembler", "Protoss", [("SelfAssemblingWorkerDisassembler", None), (
    os.path.join("SelfAssemblingWorkerDisassembler", "run.py"), "run.py")], common
)
#
